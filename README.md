...
Manually STIG-checking a single switch means checking ~65 rules by hand against the running-config, then doing it again after every change. This automates that loop across three platforms, and pushes the fixes.
