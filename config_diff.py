...
parser = argparse.ArgumentParser(description='Diff a device\'s current running-config against its last backup_config.py backup')
...
# Pull the current running config and close the session
current_output = str(net_connect.send_command('show running-config'))
